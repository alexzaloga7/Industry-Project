...
function RecentActivity() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "chatbot",
      content: "Hi Matthew, I’m your American Express AI assistant. How can I assist you today?",
      ...
      setTimeout(() => {
        ...
        switch (chatbotConvo) {
          case 0:
            newMessage = {
              sender: "chatbot",
              content: "Certainly! You have 512 reward points, Matthew. Would you like me to show you all available offers, or personalized recommended offers?",
              timestamp: getCurrentTimestamp(),
            };
            setChatbotConvo(1);
            break;
          case 1:
            newMessage = {
              sender: "chatbot",
              content: "Here are some personalized recommended offers for you...", 
              timestamp: getCurrentTimestamp(),
            };
            setChatbotConvo(2);
            break;
